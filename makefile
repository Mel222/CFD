...
$(OBJDIR)/geom_circ_rough3.o : $(SRCDIR)/geom_circ_rough3.f90 $(SRCDIR)/makefile
	@echo compiling geom_circ_rough3.f90
	@cd $(OBJDIR); $(PREP) $(F90) $(F90FLAGS) -I$(SRCDIR) $(SRCDIR)/geom_circ_rough3.f90
